...
- Name: SaucedemoLogin_Products.spec.ts >> Saucedemo Login and Products Page Tests >> TestID: TC03_LoginCreateAccount - Login with valid credentials from Create Account
